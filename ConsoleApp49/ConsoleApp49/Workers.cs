...
public static class Workers
{
    public static IEnumerable<Worker> TestData => new[]
    {
        ...
        new Worker("Joyce", Currencies.Usd.Of(64).PerHour()),
        new Worker("Jared", Currencies.Usd.Of(64).PerHour()),
        new Worker("Josie", Currencies.Usd.Of(64).PerHour()),
        new Worker("Judith", Currencies.Usd.Of(64).PerHour()),
        new Worker("Jay", Currencies.Usd.Of(64).PerHour()),
        new Worker("Jamie", Currencies.Usd.Of(64).PerHour())
    };
}